...
async def get_categories(callback: types.CallbackQuery):
    ...
    await callback.message.edit_text('Ваши категории доходов:', reply_markup=expenses_categories_keyboard)
...
async def return_from_editing(callback: types.CallbackQuery):
    ...
    await callback.message.edit_text('Ваши категории доходов', reply_markup=category_keyboard)
